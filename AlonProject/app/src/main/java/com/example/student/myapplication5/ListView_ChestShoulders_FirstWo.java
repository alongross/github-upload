...
public class ListView_ChestShoulders_FirstWo extends AppCompatActivity {
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listview_chestshoulders_firstwo);

        this.back = (Button) findViewById(R.id.back11);
        back.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                Intent intent = new Intent(ListView_ChestShoulders_FirstWo.this, End_Beginning.class);
                startActivity(intent);
            }
        });
        this.ExerciseListView = (ListView) findViewById(R.id.Listview7);
    ...
    class CustomAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            checkboxCb.setChecked(Model.getInstance().exerciseExistsInFirstWo(Model.Chest_Shoulders,bodyparts.get(position).getExercise()));
            checkboxCb.setOnClickListener(new View.OnClickListener()
            {
                @Override
                public void onClick(View v)
                {
                    Model.getInstance().addOrRemoveFromFirstWo(Model.Chest_Shoulders, nameTv.getText().toString());
                }
            });
