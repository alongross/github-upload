...
public class ListView_Back_SecondWo extends AppCompatActivity {
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listview_back_secondwo);
        this.back = (Button) findViewById(R.id.back10);
        back.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                Intent intent = new Intent(ListView_Back_SecondWo.this, End_Beginning.class);
                startActivity(intent);
            }
        });
        this.ExerciseListView = (ListView) findViewById(R.id.Listview6);
    ...
    class CustomAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            checkboxCb.setChecked(Model.getInstance().exerciseExistsInSecondWo(Model.Back,bodyparts.get(position).getExercise()));
            checkboxCb.setOnClickListener(new View.OnClickListener()
            {
                @Override
                public void onClick(View v)
                {
                    Model.getInstance().addOrRemoveFromSecondWo(Model.Back, nameTv.getText().toString());
                }
            });
