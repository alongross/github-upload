...
public class ListView_Arms_FirstWo extends AppCompatActivity {
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listview_arms_firstwo);
        this.back = (Button) findViewById(R.id.back7);
        back.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                Intent intent = new Intent(ListView_Arms_FirstWo.this, End_Beginning.class);
                startActivity(intent);
            }
        });
        this.ExerciseListView = (ListView) findViewById(R.id.Listview3);
    ...
    class CustomAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            checkboxCb.setChecked(Model.getInstance().exerciseExistsInFirstWo(Model.Arms,bodyparts.get(position).getExercise()));
            checkboxCb.setOnClickListener(new View.OnClickListener()
            {
                @Override
                public void onClick(View v)
                {
                    Model.getInstance().addOrRemoveFromFirstWo(Model.Arms, nameTv.getText().toString());
                }
            });
